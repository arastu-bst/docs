---
title: "nowrun CLI Authentication: Linking Your Account Token"
sidebarTitle: "Authentication"
description: "Run nowrun init with your token to authenticate the CLI and install the nowrun skill and MCP server, so your AI agent can deploy APKs immediately."
---

...
description: "Create your nowrun account, verify your card, and let your AI agent deploy your first Android or HTML5 web app to a live URL in under five minutes."
---
...
<Note>
  You do not need to give your agent a command cheat sheet. `nowrun login` installs the nowrun skill and MCP server, which teach the agent every available CLI command. The agent uses `nowrun help` and `nowrun <command> -h` to discover what it needs on its own.
</Note>
